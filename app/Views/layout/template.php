                ...
                <ul class="navbar-nav mr-lg-2">
                    <li class="nav-item nav-profile dropdown">
                        <a class="nav-link" href="#" data-toggle="dropdown" id="profileDropdown">
                            <img src="assets/images/lambang.jpeg" alt="profile" />
                            <span class="nav-profile-name">PEMERINTAH PROVINSI PAPUA BARAT</span>
                            </br>
                            <span class="nav-profile-name">BADAN KEPEGAWAIAN DAERAH</span>
                        </a>
                    </li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-sm-flex justify-content-center justify-content-sm-between">
                                <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2020 <a href="https://www.technojogja.com/" class="text-muted" target="_blank">Focus Techno Media</a>. All rights reserved.</span>
